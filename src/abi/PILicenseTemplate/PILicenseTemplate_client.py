...
class PILicenseTemplateClient:
    ...
    def build_exists_transaction(self, licenseTermsId, tx_params):
        return self.contract.functions.exists(licenseTermsId).build_transaction(tx_params)
    ...
    def build_getLicenseTerms_transaction(self, selectedLicenseTermsId, tx_params):
        return self.contract.functions.getLicenseTerms(selectedLicenseTermsId).build_transaction(tx_params)
    
    def getLicenseTermsId(self, terms):
        return self.contract.functions.getLicenseTermsId(terms).call()
        
    def build_getLicenseTermsId_transaction(self, terms, tx_params):
        return self.contract.functions.getLicenseTermsId(terms).build_transaction(tx_params)
