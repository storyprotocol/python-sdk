...
class TestGroupWithLicenseOperations:
    ...
    # def test_mint_register_ip_attach_license_add_to_group(self, story_client, group_with_license, ip_with_license):
    #     response = story_client.Group.mint_and_register_ip_and_attach_license_and_add_to_group(
    #         group_id=group_with_license,
    #         spg_nft_contract=MockERC721,
    #         license_data=[{
    #             'license_terms_id': ip_with_license['license_terms_id'],
    #             'licensing_config': {
    #                 'is_set': True,
...
#     @pytest.fixture(scope="module")
#     def ip_with_license(self, story_client):
#         response = story_client.IPAsset.mint_and_register_ip_asset_with_pil_terms(
#             spg_nft_contract=MockERC721,
#             terms=[{
#                 'terms': {
...
#     @pytest.fixture(scope="module")
#     def setup_royalty_collection(self, story_client):
...
#         result4 = story_client.IPAsset.mint_and_register_ip_and_make_derivative(
#             spg_nft_contract=MockERC721,
...
#         result5 = story_client.IPAsset.mint_and_register_ip_and_make_derivative(
#             spg_nft_contract=MockERC721,
#             parent_ip_ids=[group_ip_id],
#             license_terms_ids=[license_terms_id],
#             license_template=PIL_LICENSE_TEMPLATE,
