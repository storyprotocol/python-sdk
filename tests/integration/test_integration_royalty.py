...
class TestClaimAllRevenue:
    ...
    def setup_claim_all_revenue(self, story_client):
        ...
        ip_b_response = story_client.IPAsset.mintAndRegisterIpAssetWithPilTerms(
            spg_nft_contract=spg_nft_contract,
            terms=copy.deepcopy(license_terms_template),
        ...
        ip_c_response = story_client.IPAsset.mintAndRegisterIpAssetWithPilTerms(
            spg_nft_contract=spg_nft_contract,
            terms=copy.deepcopy(license_terms_template),
        ...
        ip_d_response = story_client.IPAsset.mintAndRegisterIpAssetWithPilTerms(
            spg_nft_contract=spg_nft_contract,
            terms=copy.deepcopy(license_terms_template),
    ...
    def test_claim_all_revenue(self, story_client, setup_claim_all_revenue):
