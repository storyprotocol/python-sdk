...
class TestIPAssetRegister:
    def test_register_invalid_deadline_type(self, ip_asset):
        with patch.object(
            ip_asset,
            "_get_ip_id",
            return_value="0xd142822Dc1674154EaF4DDF38bbF7EF8f0D8ECe4",
    ...
    def test_register_already_registered(self, ip_asset):
        ...
        with patch.object(ip_asset, "_get_ip_id", return_value=ip_id), patch.object(
            ip_asset, "_is_registered", return_value=True
        ):
    ...
    def test_register_successful(self, ip_asset):
        ...
        with patch.object(ip_asset, "_get_ip_id", return_value=ip_id), patch.object(
            ip_asset, "_is_registered", return_value=False
        ), patch.object(
            ip_asset.web3.eth, "get_transaction_count", return_value=0
        ), patch.object(
            ip_asset.web3.eth, "send_raw_transaction", return_value=mock_tx_hash
        ), patch.object(
            ip_asset.web3.eth,
    ...
    def test_register_with_metadata(self, ip_asset):
        ...
        with patch.object(ip_asset, "_get_ip_id", return_value=ip_id), patch.object(
            ...
            ip_asset.sign_util, "get_deadline", return_value=calculated_deadline
        ), patch.object(
            ip_asset.sign_util,
            "get_permission_signature",
            return_value={"signature": tx_hash},
        ), patch.object(
            ip_asset.web3.eth, "get_transaction_count", return_value=0
        ), patch.object(
            ip_asset.web3.eth, "send_raw_transaction", return_value=mock_tx_hash
            ...
            return_value={"ip_id": ip_id, "token_id": token_id},
        ):
